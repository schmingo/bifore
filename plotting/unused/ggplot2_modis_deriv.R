...
data.deriv <- read.csv2("csv/MODIS_20130706-1040_greyvalues_NA_derivate.csv",
                               dec = ".",
                               header = TRUE,
                               stringsAsFactors = FALSE)

data <- read.csv2("csv/MODIS_20130706-1040_greyvalues_NA.csv",
                         dec = ".", 
                         header = TRUE,
                         stringsAsFactors = FALSE)
...
png("images/modis_compare_DerivToRAW.png", 
    width = 1024 * 6, 
    height = 748 * 6, 
    units = "px", 
    res = 600)
