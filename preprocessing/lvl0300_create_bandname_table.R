...
bands <- c()
for(i in seq(1:12)) bands[i] <- paste0("band_", i)
...
greyval_bands <- c()
for(i in seq(1:12)) greyval_bands[i] <- paste0("greyvalue_band_", i)
...
diff_bands <- c()
for(i in seq(1:12)) diff_bands[i] <- paste0("derivate_band_", i)
...
sd_bands <- c()
for(i in seq(1:12)) sd_bands[i] <- paste0("sd_band_", i)
