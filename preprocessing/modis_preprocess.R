...
csv.out.NA <- "src/csv/MODIS_20130707-0940_greyvalues_NA.csv"
csv.out <- "src/csv/MODIS_20130707-0940_greyvalues.csv"
csv.out.raw <- "src/csv/MODIS_20130707-0940_RAW.csv"

csv.out.NA.deriv <- "src/csv/MODIS_20130707-0940_greyvalues_NA_derivate.csv"
