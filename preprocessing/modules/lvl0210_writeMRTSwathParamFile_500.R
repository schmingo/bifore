...
##  BiFoRe Scripts
##    
##  FUNCTION: Write Parameterfile for MRTSwath Tool (500m resolution)
##  
##  Version: 2015-02-14
##  
################################################################################
...
writeMRTSwathParamFile_500 <- function(prmfn = "tmpMRTparams.prm", 
                                       tifsdir, 
                                       modfn, geoloc_fn, 
                                       sds = NULL, 
  ...
  prmfile[[(pnum = pnum + 1)]] = 	" "
  prmfile[[(pnum = pnum + 1)]] =   "INPUT_SDS_NAME = EV_500_RefSB, 1, 1, 1, 1, 1"  
