...
df.sub.10.basics <- data10[1:length(df.sub.basics)]
len <- length(df.sub.10.basics)

df.sub.10.specno <- data10[len + 1]
len <- len + length(df.sub.10.specno)

df.sub.10.species <- data10[(len + 1):(len + length(data10.species.index))]
len <- len + length(df.sub.10.species)

df.sub.10.greyval <- data10[(len + 1):(len + length(df.sub.greyval))]
len <- len + length(df.sub.10.greyval)

df.sub.10.diff <- data10[(len + 1):(len + length(df.sub.diff))]
len <- len + length(df.sub.10.diff)

df.sub.10.sd <- data10[(len + 1):(len + length(df.sub.sd))]
